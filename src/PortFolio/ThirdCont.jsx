     ...
     <div className="card cardsone" style={{backgroundColor:'lightgray'}}>
         <div className="card-body thirdcontainer" >
            <img src={guytwo} alt='' height="400px" className="guytwo"/>
             ...
             <p className="aboutme" style={{color:'green'}}>I'm a  Full-Stack-developer.Completed training and learning skills in PREPBYTES for 6 months.I am familiar with skills and technologies like HTML,CSS,JAVASCRIPT,REACT,REDUX,NODE.JS,MONGODB for  web applications or the web page designs.My main focus is on giving the best user experience with all my skills and creativity.I am more passionate on the web applications and web designs. </p>
             ...
             <div className="tech">
              <h5 className="tech"style={{color:'green'}}>Languages/Technologies/Library</h5>
                ...
                <img  className="logos" src={reduximg} alt='' height="50px" />
                <img  className="logos" src={github} alt=''/>
                <img className="logos" src={node} height="50px" alt=''/>
                <img className="logos" src={mongodb} height="50px" alt=''/>
